          ...
          {projects.map((item) => (
            ...
            >
              <PinContainer title={item.title}>
                <div className="relative flex items-center justify-center sm:w-96 w-[80vw] overflow-hidden h-[20vh] lg:h-[24vh] mb-10">
                  <div
                ...
                <div className="flex items-center justify-between mt-7 mb-3">
                  ...
                  <div className="flex justify-center items-center">
                    ...
                    <FaLocationArrow className="ms-3" color="#659df7" />
                  </div>
                </div>
              </PinContainer>
            </div>
